  ...
  return <div className="app-shell">
    <aside className={`sidebar ${open ? 'open' : ''}`}>
      <div className="sidebar-head">
        <div className="logo-wrap"><img className="brand-logo" src="https://raw.githubusercontent.com/la86926/bio/main/resultados-de-la-prueba.png" alt="BioLog" /><div><strong>BioLog</strong><span>Laboratorio</span></div></div>
